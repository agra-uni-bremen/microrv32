...
import SC_RV32I.Core.aluSrc1
import SC_RV32I.Core.aluSrc2

//ALU Source Selection Unit
//This selection Unit works for the RegularALU following
...
// class ArithmeticModule() extends Component {
class ALU() extends Component {
    val io = new Bundle {
        ...
        val op1, op2, Imm = in Bits(32 bits)//Will connect to 'opA' and 'opB' above.
    ...
    val RegularALU = new Area {
        switch (io.instType, strict = false) {
            is(isLUI, isAUIPC, isJAL, isLOAD, isSTORE, isUndef, isECALL, isFENCE) {
                io.ALUResult := add
                io.ALUBranch := False
            }
